...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        {{-- 3. Driver Info Card --}}
        <div
            class="bg-white rounded-[2.5rem] p-6 shadow-[0_12px_28px_rgba(15,23,42,0.08)] border border-slate-200">
        ...
        {{-- 4. Trip Details --}}
        <div
            class="bg-slate-900 rounded-[2.5rem] p-6 text-white shadow-[0_22px_60px_rgba(15,23,42,0.25)]">
